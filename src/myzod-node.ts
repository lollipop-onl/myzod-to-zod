import { Node, SyntaxKind, CallExpression, PropertyAccessExpression, ExpressionStatement } from 'ts-morph';
...
export function getDirectDescendantsOfKind<T extends Node>(
    ...
    for (const child of node.getChildren()) {
        ...
        } else if (!Node.isFunctionExpression(child) && !Node.isArrowFunction(child)) {
